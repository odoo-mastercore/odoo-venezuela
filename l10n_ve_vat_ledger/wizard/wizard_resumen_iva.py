...
class ResumenIva(models.TransientModel):
    _name = "account.wizard.resumen.iva"
    ...
    def generate_xlsx_report_resumen_iva(self, workbook, account_vat):
        for obj in account_vat:
            report_name = obj.name
            print(report_name)

            # Resumen IVA
            sheet2 = workbook.add_worksheet(report_name[:31])
            ...
            sheet2.merge_range('A3:G3', obj.name + ' ' + 'Libro de IVA Compras' + ' ' + 'mes' + ' ' + 'Año',
                               title_style)
